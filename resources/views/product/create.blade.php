...
@section('content')
    <div class="container">
        <form method="post" action="{{ route('admin.product.store') }}" enctype="multipart/form-data" class="row justify-content-center">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" required placeholder="Nama Produk">
                            @error('name')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="number" min="0" class="form-control @error('stock') is-invalid @enderror" id="stock" name="stock" required>
                                @error('stock')
                                <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="form-group form-check">
                            <input type="checkbox" id="is-private" name="is_private" class="form-check-input" value="1">
